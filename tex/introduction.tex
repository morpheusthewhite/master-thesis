...
\begin{enumerate}
	\item Are the \acrlong{ECP} and the \acrlong{D-ECP} approximable? How can
	      they be solved?
	\item Are these problems capable of finding echo chambers inside social
	      medias?
\end{enumerate}

% \section{Research metodology}%
% \label{sec:research_metodology}
%
% % todo
...
\begin{enumerate}
	...
	\item \autoref{ch:complexity} provides proof regarding the complexity
	      of the problems
	\item \autoref{ch:solving} defines and prove methods for solving
	      exactly and approximating the problems
	\item \autoref{ch:resultsAndAnalysis} focuses on analyzing the
	      ...
	      obtained by applying the presented methods
	\item \autoref{ch:conclusionsAndFutureWork} presents the positive effects
	      and the drawbacks of the results as well and possible future
...
document is available at the following GitHub url
