\begin{abstract}
	...
	Social media are becoming more and more popular and used to discuss a
	...
	mainly friendly interactions.

	We will show that these problems are hard to approximate within a
	non-trivial factor and propose \acrfull{MIP} models and
