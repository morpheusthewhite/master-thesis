...
Linear programming is a widely used optimization technique and one of the most
...
In a linear programming problem we are given a cost vector $ \mathbf{c} = (c_1,
...
% \end{align*}
%
In general is possible to formulate any linear programming problem can be formulated as follows (called \emph{standard form}) \cite{Vanderbei2008}
