...
for values of $\alpha \leq 0.5$ \footnotemark.

\footnotetext{In this solution one of the definition has been changed:
	for the solution a thread $T$ is \emph{non-controversial} if $\eta(T) \leq \alpha
	$. The original case needs only a modification of the RHS of
	\autoref{eq:ecp-alpha-constraint1}}
